...
RecurrentNeuralNetwork<ActivationLossConfig>::RecurrentNeuralNetwork(int x_size, int out_size, int saved_state_size) {
...
template<class ActivationLossConfig>
void RecurrentNeuralNetwork<ActivationLossConfig>::feedForward(const Sentence& x, std::unique_ptr<arma::mat>& out_saved_states, std::unique_ptr<arma::mat>& out_outputs) {
